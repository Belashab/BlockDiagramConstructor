...
let NodesCanvas = function NodesCanvas(props) {
  ...
  let onNodePositionChange = function onNodePositionChange(nodeId, newCoordinates) {
    if (onChange) {
    ...
    return nodes && nodes.length > 1 && nodes.map(function (_ref) {
    let data = _ref.data,
...
let NodesCanvas$1 = React.memo(NodesCanvas);
